...
public:
  ...
  template <typename T> T *getRuleContext(size_t i) const {
    static_assert(std::is_base_of_v<RuleContext, T>,
                  "T must be derived from RuleContext");
  ...
  template <typename T> std::vector<T *> getRuleContexts() const {
    static_assert(std::is_base_of_v<RuleContext, T>,
                  "T must be derived from RuleContext");
