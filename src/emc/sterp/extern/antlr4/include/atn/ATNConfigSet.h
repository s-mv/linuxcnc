...
private:
  ...
  using LookupContainer =
      FlatHashSet<ATNConfig *, ATNConfigHasher, ATNConfigComparer>;
...
inline bool operator==(const ATNConfigSet &lhs, const ATNConfigSet &rhs) {
...
template <> struct hash<::antlr4::atn::ATNConfigSet> {
