...
public:
  ATNDeserializationOptions()
      : _readOnly(false), _verifyATN(true),
        _generateRuleBypassTransitions(false) {}

  // TODO: Is this useful? If so we should mark it as explicit, otherwise remove
  // it.
  ...
  ATNDeserializationOptions &
  operator=(const ATNDeserializationOptions &) = default;
  ...
  bool isGenerateRuleBypassTransitions() const {
    return _generateRuleBypassTransitions;
  }
