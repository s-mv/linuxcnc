...
protected:
  ...
  virtual void accept(CharStream *input,
                      const Ref<const LexerActionExecutor> &lexerActionExecutor,
  ...
  virtual Ref<LexerATNConfig>
  getEpsilonTarget(CharStream *input, const Ref<LexerATNConfig> &config,
                   const Transition *t, ATNConfigSet *configs, bool speculative,
