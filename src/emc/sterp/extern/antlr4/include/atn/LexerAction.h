...
public:
  ...
  ///
  /// IMPORTANT: Unlike Java, this returns LexerActionType::INDEXED_CUSTOM for
  /// instances of LexerIndexedCustomAction. If you need the wrapped action
  /// type, use LexerIndexedCustomAction::getAction()->getActionType().
...
protected:
  LexerAction(LexerActionType actionType, bool positionDependent)
      : _actionType(actionType), _hashCode(0),
        _positionDependent(positionDependent) {}
...
template <> struct hash<::antlr4::atn::LexerAction> {
