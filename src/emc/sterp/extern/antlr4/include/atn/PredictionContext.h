...
inline bool operator==(const PredictionContext &lhs,
                       const PredictionContext &rhs) {
...
template <> struct hash<::antlr4::atn::PredictionContext> {
  size_t
  operator()(const ::antlr4::atn::PredictionContext &predictionContext) const {
