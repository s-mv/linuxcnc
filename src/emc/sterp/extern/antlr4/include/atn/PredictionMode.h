...
public:
   ...
   */
  static size_t
  resolvesToJustOneViableAlt(const std::vector<antlrcpp::BitSet> &altsets);
  ...
  /// </returns>
  static bool
  hasNonConflictingAltSet(const std::vector<antlrcpp::BitSet> &altsets);
  ...
  /// false} </returns>
  static bool
  hasConflictingAltSet(const std::vector<antlrcpp::BitSet> &altsets);
  ...
  /// </pre>
  /// </summary>
  static std::vector<antlrcpp::BitSet>
  ...
  /// </pre>
  /// </summary>
  static std::unordered_map<ATNState *, antlrcpp::BitSet>
  getStateToAltMap(ATNConfigSet *configs);

  static bool hasStateAssociatedWithOneAlt(ATNConfigSet *configs);

  static size_t
  getSingleViableAlt(const std::vector<antlrcpp::BitSet> &altsets);
};
