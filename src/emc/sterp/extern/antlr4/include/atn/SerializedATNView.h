...
public:
  ...
  SerializedATNView(const_pointer data, size_type size)
...
inline bool operator==(const SerializedATNView &lhs,
                       const SerializedATNView &rhs) {
...
template <> struct hash<::antlr4::atn::SerializedATNView> {
  size_t
  operator()(const ::antlr4::atn::SerializedATNView &serializedATNView) const {
    return ::antlr4::misc::MurmurHash::hashCode(serializedATNView.data(),
                                                serializedATNView.size());
  }
};
