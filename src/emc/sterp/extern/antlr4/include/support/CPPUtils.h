...
ANTLR4CPP_PUBLIC std::string join(const std::vector<std::string> &strings,
                                  const std::string &separator);
ANTLR4CPP_PUBLIC std::map<std::string, size_t>
toMap(const std::vector<std::string> &keys);
ANTLR4CPP_PUBLIC std::string escapeWhitespace(std::string str,
                                              bool escapeSpaces);
ANTLR4CPP_PUBLIC std::string toHexString(const int t);
ANTLR4CPP_PUBLIC std::string
arrayToString(const std::vector<std::string> &data);
ANTLR4CPP_PUBLIC std::string replaceString(const std::string &s,
                                           const std::string &from,
                                           const std::string &to);
ANTLR4CPP_PUBLIC std::vector<std::string>
split(const std::string &s, const std::string &sep, int count);
ANTLR4CPP_PUBLIC std::string indent(const std::string &s,
...
template <typename T> std::string toString(const T &o) {
  std::stringstream ss;
...
ANTLR4CPP_PUBLIC std::string
what(std::exception_ptr eptr = std::current_exception());
