...
public:
  ...
  explicit TerminalNodeImpl(Token *symbol)
      : TerminalNode(ParseTreeType::TERMINAL), symbol(symbol) {}
  ...
  virtual std::string toStringTree(Parser *parser,
                                   bool pretty = false) override;
